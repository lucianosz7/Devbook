...
func (repositorio Publicacoes) CriarPub(publicacao models.Publicacao) (uint64, error) {
...
func (repositorio Publicacoes) AtualizarPub(publicacaoID uint64, publicacao models.Publicacao) error {
